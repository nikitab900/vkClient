...
class AllPublicController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.allPublicCell.text = allPublicList[indexPath.row]._name
        cell.allPublicAvatar.image = UIImage(named: allPublicList[indexPath.row]._avatar)
        return cell
    }
